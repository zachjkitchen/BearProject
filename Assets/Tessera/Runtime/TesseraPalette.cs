...
namespace Tessera
{
    ...
    {
        private static TesseraPalette m_defaultPalette;
        ...
        private static TesseraPalette CreateDefaultPalette()
        {
            var p = CreateInstance<TesseraPalette>();
            return p;
        }

        public static TesseraPalette defaultPalette  {
            get
            {
                if (m_defaultPalette == null)
                    m_defaultPalette = CreateDefaultPalette();
        ...
        public bool Match(FaceDetails a, FaceDetails b)
        {
            return Match(a.topLeft, b.topRight) &&
                ...
                Match(a.hexRightAndTopRight, b.hexTopLeftAndLeft) &&
                Match(a.hexLeftAndBottomLeft,b.hexBottomRightAndRight);
        }
