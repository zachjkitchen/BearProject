...
#region Temporary workaround for Activate and Deactive methods being missing..
        ...
        bool IsHighlight(Hit hit, TesseraTileBase t, Vector3Int offset, CellFaceDir dir, SubFace p)
        {
            if (hit?.target != t)
                return false;
        ...
        private void Repaint(Hit hit, int controlId)
        {
            ...
            var drawnWireframes = new HashSet<(TesseraTileBase, Vector3Int, CellFaceDir)>();
